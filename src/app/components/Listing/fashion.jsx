...
const Fashion = () => {
  ...
  const handleEditClick = async (card) => {
    ...
    setFormData({
      ...
      subcategory: originalData?.subcategory || "Jewelry",
      category: originalData?.category || "Fashion",
  ...
  const handleDeleteListing = async () => {
    ...
    try {
      ...
      await fetchData(pagination.currentPage);
      toast.success("Fashion listing deleted successfully!");
  ...
  const handleToggleStatus = async (card, nextActive) => {
    ...
    try {
      setIsUpdating(true);
      await postListingFlipStatus(listingId, nextActive, "Fashion");
    ...
    <>
      <div className="space-y-4">
        ...
        <ConfirmDeleteDialog
          ...
          title="Are you sure you want to delete this fashion listing?"
